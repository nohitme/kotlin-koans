...
class TimeIntervals(val unit: TimeInterval, val number: Int)
...
operator fun MyDate.plus(timeIntervals: TimeIntervals) = this.addTimeIntervals(timeIntervals.unit, timeIntervals.number)
